...
- Pendiente de confirmar por el organizador: identificación legal/domicilio aplicable y plazo definitivo de conservación. Actualmente no hay borrado automático. La integración de Google utiliza la cuenta del organizador; el alojamiento y el repositorio siguen bajo administración técnica externa.
